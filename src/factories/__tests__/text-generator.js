...
describe('text-generator', () => {
    ...
    it('will generate a number of segments', () => {
        const generatedText = _.times(100, () => textGen(textMarkov, ['a'], 1, new RegExp('\d'), new RegExp('\a'), 2));
        
        expect(generatedText).toEqual(expect.arrayContaining(['baba', 'baca', 'caba', 'caca']));
    });
});